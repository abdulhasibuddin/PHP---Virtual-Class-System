...
<?//---------------------------------------------------------------------------------------------------------------------------?>
			...
			<tr>
				<td id="td1">Profession: </td>
				<td id="td2">
					<input id="inputId" type="text" name="profession" maxlength="255" title="maximum 255 characters" value="<?php echo $profession; ?>" required><!--Profession input area-->
					<span id="error">* <?php echo $profErr; ?></span><!--Error messages related to profession-->
				</td>
			</tr>
<?//---------------------------------------------------------------------------------------------------------------------------?>
